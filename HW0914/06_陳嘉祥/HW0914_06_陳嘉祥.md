...
![CH01 04_Q26_Histogram](https://github.com/user-attachments/assets/a46a3efd-bf8e-47d0-80d5-329f146d7b97)
...
c. 隨機選定1名孩童，他的年齡小於50個月的機率: 
   ...
   $$   Probability = \frac{(12+15+12+8)}{50}=94\% $$  
...
d. 
   ...
   $$ Z-Score\ of\ Maximun=2.0 $$ 

   $$ Z-Score\ of\ Minimun=-1.2 $$ 

#### *e. Z-Score is from -1.2 to +2.0,  there are no outliers in the set.*
--- 
