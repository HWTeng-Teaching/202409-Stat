...
3. Calculate the sums of squares: Total Sum of Squares ($SS_{Total}$), Regression Sum of Squares ($SS_{Regression}$), and Residual Sum of Squares ($SS_{Error}$).![image](https://github.com/user-attachments/assets/6345a9eb-0865-4e2b-bc73-97a9ced67845)
