...
\
PS:
The margin of error (±0.085) means that we are reasonably confident (usually at a 95% confidence level if Z=1.96) that the true proportion of convicts (pp) who will lead crime-free lives for at least 3 years after prison release lies within the range:\
