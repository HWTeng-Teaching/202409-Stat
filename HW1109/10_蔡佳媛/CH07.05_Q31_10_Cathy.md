...
$P(\hat{p} \lt 0.45) \stackrel{z}\sim P({\hat{p} \lt \frac{0.45-0.47}{0.0499}) \approx P({\hat{p} \lt -o.40) = 0.6554$

![image](https://github.com/user-attachments/assets/ff14adff-d49b-4859-b249-7afb29dd70dc)
